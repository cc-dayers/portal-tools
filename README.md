...
4. Run `corepack yarn pack --out cc-dayers-portal-tools.tgz`.
5. Create the matching `vX.Y.Z` GitHub release and attach that exact asset name.
6. From `carecontinuity.app/Portals`, run `yarn start --install-tui` and verify
